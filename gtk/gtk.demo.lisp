...
(defun test-entry ()
  (within-main-loop
    (let* ((window (make-instance 'gtk-window :type :toplevel :title "Testing entry" :border-width 10))
      ...
      (g-signal-connect window "destroy" (lambda (widget) (release widget) (leave-gtk-main)))
...
(defun table-packing ()
  (within-main-loop
    (let* ((window (make-instance 'gtk-window :type :toplevel :title "Table packing" :border-width 20))
      ...
      (g-signal-connect window "destroy" (lambda (w) (release w) (leave-gtk-main)))
...
(defun test-treeview-list ()
  (within-main-loop
    (let* ((window (make-instance 'gtk-window :type :toplevel :title "Treeview (list)"))
      ...
      (gobject:g-signal-connect window "destroy" (lambda (w) (gobject:release w) (leave-gtk-main)))
